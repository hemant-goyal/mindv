...
**Community contributions welcome:** Any help would be greatly appreciated in terms of testing and generating AMR panels for WHO priority pathogens. 
...
### Sanger-validated resistance mutations (M. leprae)

4 Samples were confirmed by Sanger sequencing to carry the gyrA resistance mutation. One additional low-frequency call (sample_05, AF = 0.009) fell below Sanger's limit of detection (~15–20% AF) and could not be confirmed or excluded.
...
### M. tuberculosis — 10 public SRA samples vs TBProfiler v6.7 vs Snippy

**Cohort:** 10 WGS samples (6 resistant) from SRA — ERR1664619, ERR2510337, ERR2510445, ERR2510546, ERR2516413, ERR2516414, SRR1188186, SRR1188188, SRR2100431, SRR2100432

**Reference:** H37Rv (GCF_000195955.2, NC_000962.3) | **Panel:** `configs/tb_h37rv_live.json` (208 mutations, 10 targets)

| Drug class | Targets | mindv Sensitivity | Snippy Sensitivity | TBProfiler (ref) |
|-----------|---------|------------------|--------------------|-----------------|
| Rifampicin | rpoB | **100%** (6/6) | 83% | 100% |
| Isoniazid | katG, inhA | **100%** (6/6) | 100% | 100% |
| Fluoroquinolones | gyrA, gyrB | **100%** (3/3) | 0%* | 100% |
| Ethambutol | embB | **100%** (6/6) | 83% | 100% |
| Amikacin | rrs | **100%** (3/3) | 67% | 100% |
| Streptomycin | rpsL | 50% (2/4) | 50% | 75% |
| **Overall** | | **92.9% (26/28)** | **71.4% (20/28)** | ~95% |
| **Precision** | | **100%** | **100%** | ~99% |

*Snippy called gyrA variants but could not annotate them as resistance-conferring without a resistance database — illustrating mindv's integrated calling+annotation advantage.

**Two false negatives:** rpsL p.Ala80Pro in two samples — heuristic detected both but CNN confidence fell below threshold, attributed to underrepresentation of rpsL codon 80 in synthetic training data.

**WHO resistance classification (auto-generated):**

| Sample | Classification | Key resistances |
|--------|---------------|----------------|
| ERR1664619 | RR-TB | RIF, FQ, AMK, EMB |
| ERR2510445 | Pre-XDR-TB | RIF, INH, FQ, AMK, EMB, STR |
| ERR2510546 | Pre-XDR-TB | RIF, INH, FQ, EMB |
| ERR2516413 | MDR-TB | RIF, INH, EMB, STR |
| ERR2516414 | MDR-TB | RIF, INH, EMB, AMK |
| SRR2100432 | MDR-TB | RIF, INH, EMB |
| ERR2510337, SRR1188186/88, SRR2100431 | Susceptible | — |
...
### Step 1: Download public *M. leprae or M. tuberclosis* WGS data

Several published studies have deposited WGS data with known resistance profiles. For example:
...
- **Additional organism panels**: *S. aureus* (MRSA), *N. gonorrhoeae* (gonorrhoea) — community contributions welcome.
...
- [TBProfiler](https://github.com/jodyphelan/TBProfiler) — reference standard for TB drug resistance profiling
- [Snippy](https://github.com/tseemann/snippy) — another rapid haploid variant caller
